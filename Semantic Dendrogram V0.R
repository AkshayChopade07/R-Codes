...
### ---------------------------------- ###
### --- Amazon ALEXA Reviews dataset exercise --- ###
### ---------------------------------- ###
...
#			  removePunctuation = TRUE, stripWhitespace = TRUE, removeNumbers = TRUE,
...
#inspect(dtm)
findAssocs(dtm,c("phone"),corlimit=0.3)
inspect(dtm[1:5,1:30]) # (inverse frequency)
