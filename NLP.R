...
x<-readLines("C:/Users/hp/Downloads/Day 26 Text Mining Contd _ NLP/Data/modi.txt")
...
my_example_text <- readLines("C:/Users/hp/Downloads/Day 26 Text Mining Contd _ NLP/Data/modi.txt")
...
bio <- readLines("C:/Users/hp/Downloads/Day 26 Text Mining Contd _ NLP/Data/modi.txt")
bio <- paste(bio, collapse = " ")
bio <- as.String(bio)
word_ann <- Maxent_Word_Token_Annotator() #maximum entropy
...
model <- train_model(container, "SVM", kernel="linear", cost=1) #support vector machine 
